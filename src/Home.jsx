...
import ReviewSec from "./Home/Review";
  ...
  return (
    <div className="home-wrapper">
      ...
      <Row className="whyus">
        ...
        <Col
          className={
            isVisible ? "whyus-col-1  animation-fade-right" : "before-animation"
          }
        >
          <h3
          ...
          >
            ...
            velit magnam maxime aliquid? Itaque esse aliquam eius quasi
            consequatur dolorem error architecto accusamus, ipsum expedita vitae
            ipsa quidem non? Lorem ipsum dolor sit amet consectetur adipisicing
            elit. Excepturi, quasi repellendus dolore officiis corporis iusto,
            magnam saepe ab quaerat dolor provident odio quod quo quas est
            laborum adipisci consequuntur. Quas.
          </p>
        </Col>
      </Row>
